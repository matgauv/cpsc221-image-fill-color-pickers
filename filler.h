...
namespace filler
{
  ...
  */
  ...
  void AddNeighboursToPriority(PixelPoint & curr, PriorityNeighbours & priority, FillerConfig & config);
  bool checkVisited(PixelPoint & curr, const vector<PixelPoint> & visited);
